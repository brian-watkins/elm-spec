...
harnessTest("the setup specifies an initial location", async function(t) {
...
harnessTest("a step causes a location change", async function(t) {
...
harnessTest("clicking a link causes a location change", async function(t) {
  await harness.start("withLocation", "http://test.com/")
...
harnessTest("loading an external url", async function(t) {
  await harness.start("withLocation", "http://test.com/")
...
harnessTest("loading an external url from a port", async function(t) {
  await harness.start("withLocation", "http://test.com/")
